...
module.exports = defineConfig({
  ...
  // Set to false for consistent screenshot comparisons and sequential test execution
  // Enable (true) if you want faster test runs and tests are fully independent
  fullyParallel: false,
