 ...
 *
 * Switches between store credential sets
...
function initEnvironments() {
  ...
  // Create the default production template used for local development
  ...
  console.log(
    "\n⚠️  Update the production config with your actual store URL and API token",
  );
  console.log("   Then run: npm run env:prod\n");
}
  ...
  if (!command || command === "--help" || command === "-h") {
    console.log(
      [
        ...
        "",
        "Commands:",
        "  production   Switch to production store config",
        "  prod         Alias for production",
        "  <name>       Switch to any manually created environment",
        "  --list       List available environments",
        "  --init       Create the default production config template",
