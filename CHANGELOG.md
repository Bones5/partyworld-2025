...
- Align foundation tokens with Partyworld Figma design (Node 114-3848): Add spacing tokens ($spacing-hero-vertical, $spacing-container-wide), header tokens ($header-height-bar, $header-height-primary), brand colors (primary: #D30006, secondary: #DCDCDC), and comprehensive documentation [#4](https://github.com/Bones5/partyworld-2025/pull/4)
